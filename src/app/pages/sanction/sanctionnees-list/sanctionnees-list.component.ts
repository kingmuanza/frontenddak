...
@Component({
  selector: 'app-sanctionnees-list',
  templateUrl: './sanctionnees-list.component.html',
  styleUrls: ['./sanctionnees-list.component.scss']
})
export class SanctionneesListComponent implements OnInit {
