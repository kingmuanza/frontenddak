...
@Component({
  selector: 'app-conge-dashboard',
  templateUrl: './conge-dashboard.component.html',
  styleUrls: ['./conge-dashboard.component.scss']
})
export class CongeDashboardComponent implements OnInit {
