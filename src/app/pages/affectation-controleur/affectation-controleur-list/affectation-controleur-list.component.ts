...
@Component({
  selector: 'app-affectation-controleur-list',
  templateUrl: './affectation-controleur-list.component.html',
  styleUrls: ['./affectation-controleur-list.component.scss']
})
export class AffectationControleurListComponent implements OnInit, OnDestroy {
